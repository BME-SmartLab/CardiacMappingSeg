...
def get_config(default_config_path):
    ...
    # nameparts = config['experiment_name'].split('/') # For the Pretraining configs sweep
    # config['experiment_name'] = nameparts[0] + nameparts[-1] # For the Pretraining configs sweep
